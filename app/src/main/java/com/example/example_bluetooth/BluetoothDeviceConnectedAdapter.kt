...
class BluetoothDeviceConnectedAdapter(private var listDevice: MutableList<BluetoothDevice>) : RecyclerView.Adapter<BluetoothDeviceConnectedAdapter.ViewHolder>() {
